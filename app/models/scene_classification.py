...
class SceneClassificationModel:
    def __init__(self, model_path=None, num_classes=3, video_data=None):
        ...
        self.model.classifier[1] = nn.Linear(self.model.last_channel, num_classes)  # Modify classifier
